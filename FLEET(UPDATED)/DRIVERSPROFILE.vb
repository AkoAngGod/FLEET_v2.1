...
Public Class DRIVERSPROFILE
    Private Sub DRIVERSPROFILE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim tabWidth As Integer = (TabControl1.Width / TabControl1.TabCount) - 2
        TabControl1.ItemSize = New Size(tabWidth, 40)
    End Sub
    Sub Rowheight()
    ...
    Private Sub BILLINGSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BILLINGSToolStripMenuItem.Click
        BILLING.Show()
        Me.Close()
    End Sub
